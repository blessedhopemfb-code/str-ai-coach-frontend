...
/**
 * Parses the model's numbered-section output into structured panels.
 * Falls back to showing the raw text in a single panel if the format
 * doesn't match what we expect (the model can be inconsistent).
 */
